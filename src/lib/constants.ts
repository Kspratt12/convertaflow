...
export const TIERS: Record<TierId, TierConfig> = {
  ...
  growth: {
    ...
    description:
      "Everything in Just the Website, plus three tools that catch and convert your customers automatically. Pick extras in your portal — we build them for you.",
  ...
  scale_single: {
    ...
    features: [
      ...
      "Custom build catered to your business (you tell us what)",
