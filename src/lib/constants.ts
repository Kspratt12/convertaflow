...
export const TIERS: Record<TierId, TierConfig> = {
  ...
  growth: {
    ...
    features: [
      ...
      "Email follow-up sequences (we write them from proven templates, we run them for you)",
      "Branded confirmation emails to customers",
      "Pick from 4 portal extras: appointment booking, quote calculator, newsletter signup, or extra contact form",
  ...
  scale_single: {
    ...
    monthlyRequired: true,
    description:
      "You already have a website. We plug everything into it: all the growth tools, plus one custom system from our menu of 6. Built to do the job of an employee you don't have time to hire.",
    ...
    features: [
      ...
      "Your dashboard branded and configured for your business",
      "SMS / Missed-Call Recovery (auto-text customers when you miss a call)",
      "Customer Tracker (tag every lead from first call to closed job)",
      "Google Business Profile fully optimized + weekly posts",
      "Local SEO setup (compete for 'near me' searches in your area)",
      "Auto Review System (auto-request reviews + we draft replies for you to approve in 1 click)",
  ...
  scale: {
    ...
    features: [
      ...
      "Customer Tracker (tag every lead from first call to closed job)",
      "Google Business Profile + Local SEO (set up to compete for 'near me' searches)",
      "Auto Review System (auto-request reviews + we draft replies for you to approve in 1 click)",
      "Your dashboard branded and configured for your business",
