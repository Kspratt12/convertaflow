      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-10 max-w-2xl text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl lg:text-[2.75rem] lg:leading-tight">
            Three steps to a business that grows itself
          </h2>
        </div>
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-2">
                <span className="text-[36px] sm:text-[40px] font-extrabold leading-none bg-gradient-to-b from-white/20 to-white/[0.04] bg-clip-text text-transparent">
                  {step.step}
                </span>
