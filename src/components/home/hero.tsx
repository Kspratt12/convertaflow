    ...
    <section className="relative overflow-hidden bg-[#060613] text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-10 sm:px-6 sm:pb-24 sm:pt-20 lg:px-8">
        <div className="grid items-center gap-10 lg:gap-16 lg:grid-cols-5">
          ...
          {/* Visual — rotating cube + floating cards (desktop only) */}
          <motion.div
        ...
        {/* Dashboard mockup */}
        <motion.div
          className="relative mx-auto mt-12 sm:mt-24 max-w-5xl"
            ...
            <div className="grid grid-cols-12">
              <div className="col-span-3 hidden border-r border-white/[0.06] bg-white/[0.01] p-3 sm:p-5 lg:block">
                {["Overview", "Leads", "Reviews", "Email", "Social", "Settings"].map((item, i) => (
                  <div
                    key={item}
                    className={`rounded-lg px-2 py-1.5 sm:px-3 sm:py-2 text-[11px] sm:text-[13px] ${
                      i === 0
              ...
              <div className="col-span-12 p-4 sm:p-6 lg:col-span-9">
                ...
                <div className="grid gap-2 sm:gap-3 grid-cols-3">
                  {[
                    ...
                    { label: "Reviews", value: "23", change: "+8%" },
                    { label: "Conversion", value: "4.2%", change: "+0.6%" },
                  ].map((s) => (
      ...
      <div className="absolute bottom-0 left-0 right-0 h-16 sm:h-20 bg-gradient-to-b from-transparent to-background" />
    </section>
  );
}
