...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-[#060613] text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-10 sm:px-6 sm:pb-20 sm:pt-20 lg:px-8">
        <div className="grid items-center gap-10 lg:gap-8 lg:grid-cols-2">
          {/* Copy */}
        ...
        {/* Dashboard mockup */}
        <motion.div className="relative mx-auto mt-12 sm:mt-16 max-w-5xl" initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.55 }}>
